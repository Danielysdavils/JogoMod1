...
var suich = 0
    ...
    if(suich === 0){
    function atras(){
        window.location.href = "http://127.0.0.1:5500/Fases/Desafios/mago/Nivel4/html/004.html"
        }
    }
...
function escolher(){
    ...
    while(nVidas >= 1){
        ...
        if(res.indexOf("3") >= 0){
            alert(`Muito Bem!`)
            window.location.href = ("http://127.0.0.1:5500/Fases/Desafios/mago/Nivel6/html/006.html")
            break;
        }else{
    ...
    if(nVidas == 0){
        window.location.href = ("http://127.0.0.1:5500/Fases/Desafios/mago/Nivel5/html/gameover.html")
    }
}
