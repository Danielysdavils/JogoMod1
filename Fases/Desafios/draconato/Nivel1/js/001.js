...
var suich = 0
    ...
    if(suich === 0){
    function atras(){
        window.location.href = "http://127.0.0.1:5500/Fases/selecaoPer/002.html"
        }
    }
...
function escolher(){
    ...
    if(nVidas == 0){
        window.location.href = ("http://127.0.0.1:5500/Fases/Desafios/draconato/Nivel1/html/001.html")
    }
}
