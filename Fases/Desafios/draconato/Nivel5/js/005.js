...
function escolher(){
    ...
    while(nVidas >= 1){
        ...
        if(res.indexOf("2") >= 0){
            alert(`Muito Bem!`)
            window.location.href = ("http://127.0.0.1:5500/Fases/Desafios/draconato/Nivel6/html/006.html")
            break;
        }else{
    ...
    if(nVidas == 0){
        window.location.href = ("http://127.0.0.1:5500/Fases/Desafios/draconato/Nivel5/html/gameover.html")
    }
}
