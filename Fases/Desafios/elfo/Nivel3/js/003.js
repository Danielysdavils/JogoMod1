...
var suich = 0
    ...
    if(suich === 0){
    function atras(){
        window.location.href = "http://127.0.0.1:5500/Fases/Desafios/elfo/Nivel2/html/002.html"
        }
    }
...
function escolher(){
    ...
    if(nVidas == 0){
        window.location.href = ("http://127.0.0.1:5500/Fases/Desafios/elfo/Nivel3/html/gameover.html")
    }
}
