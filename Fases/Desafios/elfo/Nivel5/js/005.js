...
function escolher(){
    ...
    while(nVidas >= 1){
        ...
        if(res.indexOf("2") >= 0){
            alert(`Muito Bem!`)
            window.location.href = "file:///C:/Users/Ebanx/Documents/DanielysEstudio/JogoMod1/Fases/Desafios/elfo/Nivel6/html/006.html"
            break;
        }else{
    ...
    if(nVidas == 0){
        window.location.href = "file:///C:/Users/Ebanx/Documents/DanielysEstudio/JogoMod1/Fases/Desafios/elfo/Nivel5/html/gameover.html"
    }
}
