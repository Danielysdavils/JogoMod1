...
var suich = 0
    ...
    if(suich === 0){
    function atras(){
        window.location.href = "http://127.0.0.1:5500/Fases/Desafios/Ana/Nivel1/html/001.html"
        }
    }
...
function escolher(){
    ...
    while(nVidas >= 1){
        ...
        if(res.indexOf("3") >= 0){
            alert(`Muito Bem!`)
            window.location.href = ("http://127.0.0.1:5500/Fases/Desafios/Ana/Nivel3/html/003.html")
            break;
        }else{
    ...
    if(nVidas == 0){
        window.location.href = ("http://127.0.0.1:5500/Fases/Desafios/Ana/Nivel2/html/gameover02.html")
    }
}
